...
import { FILM_PROFILES } from './filmLabConstants.js';

// ============================================================================
// 内置胶片曲线配置
// ============================================================================

// Re-export FILM_PROFILES as FILM_CURVE_PROFILES for curve-specific usage
export const FILM_CURVE_PROFILES = FILM_PROFILES;
 ...
 */
export function applyFilmCurve(value, profile = {}) {
 ...
 */
export function applyFilmCurveRGB(r, g, b, profile = {}) {
  return [
 ...
 */
export function buildFilmCurveLUT(profile = {}) {
 ...
 */
export function getBuiltinFilmProfile(profileKey) {
 ...
 */
export function mergeFilmProfiles(customProfiles = []) {
  // 内置配置
  const merged = {};
 ...
 */
export function groupFilmProfilesByCategory(profiles) {
  const groups = {
    color: [],
    bw: [],
    custom: [],
