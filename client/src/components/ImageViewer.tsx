...
interface ImageViewerProps {
  ...
  index?: number;
  onClose: () => void;
  onPhotoUpdate?: (photoId?: number, data?: any) => void;
  viewMode?: string;
  roll?: any;
}

export default function ImageViewer({ images = [], index = 0, onClose, onPhotoUpdate, viewMode = 'positive', roll }: ImageViewerProps) {
