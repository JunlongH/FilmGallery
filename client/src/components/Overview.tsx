...
export default function Overview(): React.JSX.Element {
  ...
  const [mode, setMode] = useState<ViewMode>('rolls');
  ...
  return (
    <div style={{ padding: '0 20px 40px' }}>
      ...
      {/* @ts-ignore - type mismatch with FilterPanel onChange */}
      ...
      {(mode==='rolls' ? rollsQuery.isLoading : photosQuery.isLoading) ? (
        ...
        >
          {mode==='rolls' ? (
            ...
            /* @ts-ignore - PhotoGrid types need update */
