...
export default function FilmLab({ imageUrl, onClose, onSave, rollId, photoId, onPhotoUpdate }) {
  ...
  const pushToHistory = () => {
    setHistory(prev => [...prev, {
      inverted, inversionMode, exposure, contrast, highlights, shadows, whites, blacks, temp, tint, red, green, blue, curves, rotation, cropRect,
      lut1: lut1 ? { ...lut1 } : null,
      lut2: lut2 ? { ...lut2 } : null
    }]);
    setFuture([]);
  ...
  const handleUndo = () => {
    ...
    setInversionMode(previous.inversionMode || 'linear');
    ...
    setLut1(previous.lut1 || null);
    setLut2(previous.lut2 || null);
  };
  ...
  const handleRedo = () => {
    ...
    setInversionMode(next.inversionMode || 'linear');
    ...
    setLut1(next.lut1 || null);
    setLut2(next.lut2 || null);
  };
