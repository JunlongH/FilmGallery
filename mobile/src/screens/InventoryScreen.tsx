...
import { FILM_ITEM_STATUS_FILTERS, FILM_ITEM_STATUS_LABELS, FilmItemStatus } from '../constants/filmItemStatus';
...
const InventoryScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const [allItems, setAllItems] = useState<FilmItem[]>([]);
  ...
  const filmById = useMemo((): Map<number, Film> => {
