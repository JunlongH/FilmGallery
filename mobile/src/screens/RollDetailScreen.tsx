...
import { ActivityIndicator, Text, Surface, Divider, IconButton, useTheme, Switch, MD3Theme } from 'react-native-paper';
...
type Props = NativeStackScreenProps<RootStackParamList, 'RollDetail'>;

const numColumns = 3;
const screenWidth = Dimensions.get('window').width;
const tileSize = Math.floor((screenWidth - (spacing.sm * 2) - (numColumns * 2)) / numColumns);

const RollDetailScreen: React.FC<Props> = ({ route, navigation }) => {
