...
import { RootStackParamList, Roll } from '../types';

type Props = NativeStackScreenProps<RootStackParamList, 'EquipmentRolls'>;

const EquipmentRollsScreen: React.FC<Props> = ({ route, navigation }) => {
  ...
  const renderItem: ListRenderItem<Roll> = ({ item }) => {
...
export default EquipmentRollsScreen;
