...
import { RootStackParamList, LocationDiagnostics, LocationResult } from '../types';

type Props = NativeStackScreenProps<RootStackParamList, 'LocationDiagnostic'>;

const LocationDiagnosticScreen: React.FC<Props> = () => {
...
export default LocationDiagnosticScreen;
