 ...
 * 
 * Manages upload directories with support for:
 * - DATA_ROOT: New standard environment variable
 * - UPLOADS_ROOT: Legacy storage root
 * - USER_DATA: Fallback to userData/uploads
 * - Local temp directory for file processing
 */
...
if (!fs.existsSync(rollsDir)) {
  fs.mkdirSync(rollsDir, { recursive: true });
}
...
export { uploadsDir, tmpUploadDir, localTmpDir, rollsDir, filmDir };
