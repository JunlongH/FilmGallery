 ...
 * @param {number} [params.exposure=0] - Exposure adjustment (-100 to 100)
 * @param {number} [params.contrast=0] - Contrast adjustment (-100 to 100)
 * @param {number} [params.highlights=0] - Highlights adjustment (-100 to 100)
 * @param {number} [params.shadows=0] - Shadows adjustment (-100 to 100)
 * @param {number} [params.whites=0] - Whites adjustment (-100 to 100)
 * @param {number} [params.blacks=0] - Blacks adjustment (-100 to 100)
 * @returns {Uint8Array} 256-element LUT
 */
 ...
 * @param {number[]} xs - X coordinates (sorted ascending)
 ...
 * @param {Array<{x: number, y: number}>} points - Curve control points (0-255 range)
 * @returns {Uint8Array} 256-element LUT
 */
 ...
 * @param {Buffer} buffer - Raw pixel buffer (RGB or RGBA)
 * @param {Uint8Array} lut - 256-element LUT
 * @param {number} [channels=3] - Number of channels (3 for RGB, 4 for RGBA)
 */
function applyLUT(buffer, lut, channels = 3) {
 ...
 * @param {Buffer} buffer - Raw pixel buffer (RGB or RGBA)
 * @param {Uint8Array} rLut - Red channel LUT
 * @param {Uint8Array} gLut - Green channel LUT
 * @param {Uint8Array} bLut - Blue channel LUT
 * @param {number} [channels=3] - Number of channels
 */
function applyChannelLUTs(buffer, rLut, gLut, bLut, channels = 3) {
  for (let i = 0; i < buffer.length; i += channels) {
 ...
 * @returns {Uint8Array} 256-element identity LUT
 */
